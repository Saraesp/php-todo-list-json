    ...
    <body>
        <div id="app">
            <div class="container">
                ...
                <div class="row w-75 centered-content">
                    <div class="col-12">
                        <ul class="list-unstyled bg-white p-4">
                            <li class="p-2 text-secondary border border-secondary" v-for="(todo, index) in todoList">
                                <div class="d-flex justify-content-between align-items-center"> 
                                    ...
                                    <div v-else>
                                        <div class="row">
                                            ...
                                            <div>
                                                <button class="m-1 btn btn-primary" @click="confirmUpdate(todo.name, index)">Conferma</button>
                                            </div>
                                        </div>
                                    </div>

                                    <div>
                                        <button class="m-1 btn btn-danger" @click="deleteTodo(index)"><i class="fa fa-trash"></i></button>
                                        <button class="m-1 btn btn-warning" @click="editTodo(index)"><i class="fa fa-edit"></i></button>
                                    </div>
                                </div>
